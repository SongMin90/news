	...
	<div class="container">
		<div class="line bouncein">
			<div class="xs6 xm4 xs3-move xm4-move">
				...
				<form action="${pageContext.request.contextPath}/user_findPwd.html"
					method="post">
							...
							<div class="form-group">
								<div class="field field-icon-right">
									<input type="text" class="input input-big" name="user_email"
										id="user_email" placeholder="您的邮箱地址"
										placeholder="邮箱地址，可用于找回密码"
										data-validate="required:请填写邮箱,email:邮箱格式不正确,ajax1#user_checkEmail.html?user_email=:邮箱不存在" />

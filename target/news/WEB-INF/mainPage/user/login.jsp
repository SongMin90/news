...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${pageContext.request.contextPath}/user_login.html" method="post">
            <div class="panel loginbox" style="background:url(images/sys/tmbg-white.png);">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="user_name" placeholder="登录昵称" data-validate="required:请填写昵称" />
				...
				<div class="form-group">
					<div class="field text-center">
						<p class="text-muted text-center"> <a class="" href="${pageContext.request.contextPath}/user_toRegister.html">立即注册</a> | <a class="" href="${pageContext.request.contextPath}/user_toFpwd.html">忘记密码？</a>
						</p>
					</div>
				</div>
				<div></div>

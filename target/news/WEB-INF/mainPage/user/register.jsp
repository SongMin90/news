...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="${pageContext.request.contextPath}/user_register.html" method="post">
            <div class="panel loginbox" style="background:url(images/sys/tmbg-white.png);">
                <div class="text-center margin-big padding-big-top"><h1>新用户注册</h1></div>
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    <div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="user_name" id="user_name" placeholder="登录昵称" data-validate="required:请填写昵称,ajax#user_checkName.html?user_name=:昵称已经存在" />
					...
					<div class="form-group">
                        <div class="field field-icon-right">
                            <input type="password" class="input input-big" name="user_password1" placeholder="确认密码" data-validate="required:请填写确认密码,repeat#user_password:两次输入的密码不一致" />
                            <span class="icon icon-key margin-small"></span>
                        </div>
                    </div>
					<div class="form-group">
                        <div class="field field-icon-right">
                            <input type="text" class="input input-big" name="user_email" id="user_email" placeholder="邮箱地址，可用于找回密码" data-validate="required:请填写邮箱,email:邮箱格式不正确,ajax#user_checkEmail.html?user_email=:邮箱已经存在" />
